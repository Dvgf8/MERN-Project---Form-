...
import { usseParams, useNavigate } from "react-router-dom";
    ...
    async function onSubmit(e) {
        ...
        try {
            ...
            if (isNew) {
                ...
                response = await fetch (`http://localhost:5050/${params.id}`, 
                    {
                        method: "PATCH",
                        headers: {
                            "Content-type": "application/json",
        ...
        <>
            ...
            >
                ...
                border-slate-900/10 pb-12 md:grid-cols-2">
                    <div>
                        ...
                        <p className="mt-1 text-sm leading-6 text-slate-600">
                            This information will be saved and displayed publicly so be careful what you enter.
                        </p>
                    </div>
                    <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                        <div className="sm:col-span-4">
                            ...
                            <div className="mt-2">
                                ...
                                ring-inset ring-slate-300 focus-within:ring-2
                                ...
                                sm:max-w-md">
                                    <input
                                        ...
                                        py-1.5 pl-1 text-slate-900
                                        placeholder:text-slate-400 focus-ring-0 sm:text-sm
                                        sm:leading-6"
                                ...
                                sm:space-x-10 sm:space-y-0">
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            text-slate-600 focus:ring-slate-600
                                            cursor-pointer"
                ...
                <input
                    ...
                    hover:bg-slate-100 hover:text-accent-foreground h-9
